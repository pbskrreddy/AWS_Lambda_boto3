...
instances = ec2.instances.filter(InstanceIds=['i-0d7239e99198f55df'])
...
for image_id in image_ids:
    client.copy_image(Name='Boto3 Copy'+image_id, SourceImageId=image_id, SourceRegion='us-east-1')
